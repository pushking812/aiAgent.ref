...
@pytest.fixture
def mock_tk_parent():
    """Создает mock родительского окна Tkinter."""
    parent = Mock()
...
class TestDialogsViewRealTkinter:
    ...
    def test_real_dialogs_view_creation(self, real_tk_root):
    ...
    def test_real_directory_overwrite_dialog(self, real_tk_root):
        """Тест создания DirectoryOverwriteDialog с реальным Tkinter."""
        dialog = DirectoryOverwriteDialog(real_tk_root, "/test/path", "TestProject")
        assert dialog is not None
