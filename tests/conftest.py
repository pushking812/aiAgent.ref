...
def code_editor_view(tk_root):
    ...
    try:
        ...
        pytest.skip(f"Не удалось импортировать CodeEditorView: {e}")
...
def main_window_view(tk_root):
    ...
    try:
        ...
        pytest.skip(f"Не удалось импортировать MainWindowView: {e}")
...
def dialogs_view(tk_root):
    ...
    try:
        ...
        pytest.skip(f"Не удалось импортировать DialogsView: {e}")
...
def project_tree_view(tk_root):
    ...
    try:
        ...
        pytest.skip(f"Не удалось импортировать ProjectTreeView: {e}")
